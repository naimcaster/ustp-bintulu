                    ...
                    <div class="col-xl-4 col-lg-6 wow slideInUp" data-wow-delay="0.1s">
                        <div class="bg-light rounded h-100 p-5">
                            <div class="section-title">
                                ...
                                <h1 class="display-6 mb-4">Perkhidmatan Percuma</h1>
                            </div>
                            <div class="d-flex align-items-center mb-2">
                                <i class="bi bi-geo-alt fs-1 text-primary me-3"></i>
                                <div class="text-start">
                                    <h5 class="mb-0">Pejabat Pendidikan Daerah Bintulu</h5>
                                    <span>Km 5 Jalan Sultan Iskandar 97000 Bintulu</span>
                                </div>
                            </div>
                            <div class="d-flex align-items-center mb-2">
                    ...
                    <div class="col-xl-4 col-lg-6 wow slideInUp" data-wow-delay="0.3s">
                        <form>
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <button class="btn btn-primary w-100 py-3" type="submit">Hantar Pesanan</button>
                                </div>
                            </div>
                        </form>
                    </div>
