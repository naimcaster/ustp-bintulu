                ...
                <div class="row g-5">
                    <div class="col-lg-7">
                        <div class="section-title mb-4">
                            ...
                            <h1 class="display-5 mb-0">SHINE BINTULU SHINE</h1>
                        </div>
                        <h4 class="text-body fst-italic mb-4">MEMPERKASAKAN PENDIDIKAN MELESTARIKAN KEMENJADIAN MURID</h4>
                        <p class="mb-4">PPD Bintulu komited dalam meningkatkan kecekapan dan keberkesanan tadbir urus serta proses penyampaian perkhidmatan bagi memenuhi kehendak pelanggan dan aspirasi negara selaras matlamat dan Falsafah Pendidikan Kebangsaan.</p>
                        <div class="row g-3">
                            <div class="col-sm-6 wow zoomIn" data-wow-delay="0.3s">
                                <h5 class="mb-3"><i class="fa fa-check-circle text-primary me-3"></i>Proram transformasi sekolah 2025(TS25)</h5>
                                <h5 class="mb-3"><i class="fa fa-check-circle text-primary me-3"></i>Staff Berdedikasi
                                </h5>
                            </div>
                            <div class="col-sm-6 wow zoomIn" data-wow-delay="0.6s">
                                <h5 class="mb-3"><i class="fa fa-check-circle text-primary me-3"></i>Isnin-Jumaat/8 pagi- 5 ptg Beroperasi</h5>
                                <h5 class="mb-3"><i class="fa fa-check-circle text-primary me-3"></i>Perkhidmatan Percuma</h5>
                            </div>
                        </div>
                        <a href="appointment.html" class="btn btn-primary py-3 px-5 mt-4 wow zoomIn"
                            data-wow-delay="0.6s">Hubungi Kami</a>
                    </div>
                    <div class="col-lg-5" style="min-height: 500px;">
                        <div class="position-relative h-100">
                            <img class="position-absolute w-100 h-100 rounded wow zoomIn" data-wow-delay="0.9s"
                                src="{{ asset('img/Tuan-PPD-2.png') }}" style="object-fit: cover;">
                        </div>
                    </div>
                </div>
            </div>
